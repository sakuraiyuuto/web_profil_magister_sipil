...
class KelompokKeahlianDosenController extends Controller
{
    public function menuKelompokKeahlianDosen()
    {
        ...
        return view('portal.kelompok_keahlian_dosen.index',  compact('kelompokKeahlianDosens', 'dosens', 'aplikasiIntegrasis', 'informasiTerbarus',  'profilSingkat', 'kontak', 'penunjangHeaders'));
    }
}
