                                                ...
                                                <div class="row" style="height : 10rem">
                                                        ...
                                                        <div class="kf_event_list_thumb">
                                                            <figure style="height : 13rem">
                                                                <img style="height : 15rem; width:100%; object-fit :cover"
                                                                    src="{{ url($pengabdianKepadaMasyarakat->thumbnail) }}"
                                                                    alt="" />
                                                            </figure>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-9">
                                                        ...
                                                        <div class="kf_event_list_des" style="padding: 10px 10px 10px 0;">
                                                            <h4><a
                                                                    href="{{ url($pengabdianKepadaMasyarakat->slug) }}"><span>{{ $pengabdianKepadaMasyarakat->judul }}</span></a>
                                                            </h4>
                                                            <ul class="kf_event_list_links">
                                                                <li><a>Pelaku KKL :
                                                                        {{ $pengabdianKepadaMasyarakat->author }}</a></li>
                                                                <br>
                                                                <li><a>Tahun KKL :
                                                                        {{ $pengabdianKepadaMasyarakat->tahun }}</a></li>
                                                            </ul>
                                                            <a class="readmore"
                                                                href="{{ url($pengabdianKepadaMasyarakat->slug) }}">
                                                                Selengkapnya
