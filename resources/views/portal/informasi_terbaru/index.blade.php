...
@section('title', 'Semua Informasi - Magister Teknik Sipil UNTAN')
                ...
                <div class="col-md-12">
                    ...
                    <div class="kf_inr_ban_des">
                        <div class="inr_banner_heading">
                            <h3>Semua Informasi</h3>
                        </div>
                        <div class="kf_inr_breadcrumb">
                            <ul>
                                <li><a href="{{ url('') }}">Beranda</a></li>
                                <li><a>Semua Informasi</a></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8">
                        <div class="row">
                            <?php $x = 0; ?>
                            @foreach ($informasiTerbaruPaginates as $informasiTerbaru)
                                <?php $x = $x + 1; ?>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="blog_3_wrap">
                                        ...
                                        <ul class="blog_3_sidebar" style="z-index: 1;">
                                            <li>
                                                <a href="#">
                                                    {{ date('d', strtotime($informasiTerbaru->release_date)) }}
                                                    <span>
                                                        {{ substr(date('F', strtotime($informasiTerbaru->release_date)), 0, 3) }}
                                                    </span>
                                                </a>
                                            </li>
                                        </ul>
                                        ...
                                        <div class="blog_3_des">
                                            <figure>
                                                <img class="img-news" src="{{ url($informasiTerbaru->thumbnail) }}"
                                                    alt="" />
                                            ...
                                            <li> <i class="fa fa-calendar"></i>
                                                {{ date(' Y', strtotime($informasiTerbaru->release_date)) }}</li>
                                            <p>
                                            ...
                                            <a class="readmore" href="{{ url($informasiTerbaru->slug) }}">
                                                Selengkapnya
                    ...
                    <div class="kf_edu_pagination_wrap">
                        <ul class="pagination">
                            <div class="center">
                                <ul class="pagination">
                                    {{ $informasiTerbaruPaginates->links('pagination::default') }}
                                </ul>
                            </div>
                        </ul>
                    </div>
