...
@section('title', 'Jurnal - Magister Teknik Sipil UNTAN')
                                ...
                                <tbody>
                                    @foreach ($jurnals as $jurnal)
                                        <tr>
                                            ...
                                            @if ($jurnal->nama_file != '')
                                                <td><a class="btn btn-primary" href="{{ url($jurnal->nama_file) }}"
                                                        download target="_blank">Link</a></td>
                                            @else
                                                <td><a class="btn btn-primary" href="{{ url($jurnal->url) }}"
