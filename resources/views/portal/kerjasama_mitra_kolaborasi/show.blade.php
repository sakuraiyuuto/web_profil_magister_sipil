                ...
                <div class="col-md-12">
                    ...
                    <div class="kf_inr_ban_des">
                        <div class="inr_banner_heading">
                            <h3>Detail Kerjasama & Mitra Kolaborasi</h3>
                        </div>

                        <div class="kf_inr_breadcrumb">
                            <ul>
                                <li><a href="{{ url('') }}">Beranda</a></li>
                                <li><a href="{{ url('/kerjasama_mitra_kolaborasi') }}">Detail Kerjasama & Mitra
                                        Kolaborasi</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="kf_blog_detail_wrap">
                            ...
                            <div class="blog_detail_thumbnail">
                                <figure>
                                    <img src="{{ url($kerjasamaMitraKolaborasi->thumbnail) }}" alt="" />
                                    <figcaption><a href="#">Kerjasama & Mitra Kolaborasi</a></figcaption>
                                </figure>
                            </div>
                            ...
                            <div class="kf_blog_detail_des">
                                <div class="blog-detl_heading">
                                    <h5>{{ $kerjasamaMitraKolaborasi->judul }}</h5>
                                </div>
