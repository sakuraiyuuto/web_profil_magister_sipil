                ...
                <div class="col-md-12">
                    ...
                    <div class="kf_inr_ban_des">
                        <div class="inr_banner_heading">
                            <h3>Kerjasama Mitra Kolaborasi</h3>
                        </div>
                        <div class="kf_inr_breadcrumb">
                            <ul>
                                <li><a href="{{ url('') }}">Beranda</a></li>
                                <li><a>Kerjasama Mitra Kolaborasi</a></li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="blog_3_wrap">
                                        ...
                                        <ul class="blog_3_sidebar" style="z-index: 1;">
                                            <li>
                                                <a href="#">
                                                    {{ date('d', strtotime($kerjasamaMitraKolaborasi->release_date)) }}
                                                    <span>
                                                        {{ substr(date('F', strtotime($kerjasamaMitraKolaborasi->release_date)), 0, 3) }}
                                                    </span>
                                                </a>
                                            </li>
                                        </ul>
                                        ...
                                        <div class="blog_3_des">
                                            <figure>
                                                <img class="img-news"
                                                    src="{{ url($kerjasamaMitraKolaborasi->thumbnail) }}" alt="" />
                                                <figcaption><a href="{{ url($kerjasamaMitraKolaborasi->slug) }}"><i
                                                            class="fa fa-search-plus"></i></a>
                                                </figcaption>
                                            </figure>
                                            <h5><a
                                                    href="{{ url($kerjasamaMitraKolaborasi->slug) }}">{{ $kerjasamaMitraKolaborasi->judul }}</a>
                                            </h5>
                                            <p>
                                                @if (strlen(strip_tags($kerjasamaMitraKolaborasi->teks)) > 256)
                                                    {{ str_replace('&nbsp;', '', substr(strip_tags($kerjasamaMitraKolaborasi->teks), 0, 256) . '...') }}
                                                @else
                                                    {{ str_replace('&nbsp;', '', substr(strip_tags($kerjasamaMitraKolaborasi->teks), 0, 256)) }}
                                                @endif
                                            </p>
                                            <a class="readmore" href="{{ url($kerjasamaMitraKolaborasi->slug) }}">
                                                Selengkapnya
                    ...
                    <div class="kf_edu_pagination_wrap">
                        <ul class="pagination">
                            <div class="center">
                                <ul class="pagination">
                                    {{ $kerjasamaMitraKolaborasis->links('pagination::default') }}
                                </ul>
                            </div>
                        </ul>
                    </div>
