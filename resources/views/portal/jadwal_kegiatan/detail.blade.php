...
@section('title', 'Jadwal Kegiatan - Magister Teknik Sipil UNTAN')
                    ...
                    <div class="kf_inr_ban_des">
                        ...
                        <div class="kf_inr_breadcrumb">
                            <ul>
                                ...
                                <li><a href="{{ url('/jadwal_kegiatan') }}">Jadwal Kegiatan</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="kf_blog_detail_wrap">
                            ...
                            <div class="blog_detail_thumbnail">
                                <figure>
                                    <img src="{{ url($jadwalKegiatan->thumbnail) }}" alt="" />
                                    <figcaption><a href="#">Jadwal Kegiatan</a></figcaption>
                                </figure>
                            </div>
                            ...
                            <div class="kf_blog_detail_des">
                                <div class="blog-detl_heading">
                                    <h5>{{ $jadwalKegiatan->judul }}</h5>
                                </div>

                                <ul class="blog_detail_meta">
                                    <li><i class="fa fa-calendar"></i><a
                                            href="#">{{ date('d M, Y', strtotime($jadwalKegiatan->release_date)) }}</a>
                                    </li>
                                </ul>
                                <ul class="blog_detail_meta">
                                    <li><a href="#">Pelaksana Kegiatan : {{ $jadwalKegiatan->author }}</a>
                                    </li>
                                </ul>
                                <ul class="blog_detail_meta">
                                    <li><a href="#">Tahun Kegiatan : {{ $jadwalKegiatan->tahun }}</a>
                                    </li>
                                </ul>

                                <p>{!! $jadwalKegiatan->teks !!}
