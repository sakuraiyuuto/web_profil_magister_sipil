...
@section('title', 'Informasi Beasiswa - Magister Teknik Sipil UNTAN')
                ...
                <div class="col-md-12">
                    ...
                    <div class="kf_inr_ban_des">
                        <div class="inr_banner_heading">
                            <h3>Detail Informasi Beasiswa</h3>
                        </div>

                        <div class="kf_inr_breadcrumb">
                            <ul>
                                <li><a href="{{ url('') }}">Beranda</a></li>
                                <li><a href="{{ url('/informasi_beasiswa') }}">Informasi Beasiswa</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="kf_blog_detail_wrap">
                            ...
                            <div class="blog_detail_thumbnail">
                                <figure>
                                    <img src="{{ url($informasiBeasiswa->thumbnail) }}" alt="" />
                                    <figcaption><a href="#">Informasi Beasiswa</a></figcaption>
                                </figure>
                            </div>
