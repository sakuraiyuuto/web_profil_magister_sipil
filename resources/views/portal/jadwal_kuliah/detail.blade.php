...
@section('title', 'Jadwal Kuliah - Magister Teknik Sipil UNTAN')
                    ...
                    <div class="kf_inr_ban_des">
                        ...
                        <div class="kf_inr_breadcrumb">
                            <ul>
                                ...
                                <li><a href="{{ url('/jadwal_kuliah') }}">Jadwal Kuliah</a></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="kf_blog_detail_wrap">
                            ...
                            <div class="kf_blog_detail_des">
                                <div class="blog-detl_heading">
                                    <h5>Jadwal Kuliah Semester {{ $jadwalKuliah->semester }} Tahun Akademik
                                        {{ $jadwalKuliah->tahun_ajaran }}</h5>
                                </div>

                                <p>Dokumen :</p>
                                <div class="embed-responsive embed-responsive-4by3">
                                    <object data="{{ url($jadwalKuliah->nama_file) }}" type="application/pdf">
                                        <iframe
