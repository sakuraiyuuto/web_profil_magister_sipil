                                        ...
                                        @foreach ($informasiTerbarus as $informasiTerbaru)
                                            ...
                                            <div class="col-md-4">
                                                <div class="edu2_cur_wrap">
                                                    <figure>
                                                        <img src="{{ $informasiTerbaru->thumbnail }}" alt=""
                                                    ...
                                                    <div class="edu2_cur_des  new_info_bg">
                                                        <h5><a
                                                                href="{{ $informasiTerbaru->slug }}">{{ $informasiTerbaru->judul }}</a>
                                                        </h5>
                                                        <strong>
                                                            <span><i class="fa fa-calendar"></i>
                                                                {{ date('d M, Y', strtotime($informasiTerbaru->release_date)) }}</span>
                                                        </strong>
                            ...
                            @foreach ($quotes as $quote)
                                <div class="item quotes-size">
                                    ...
                                    <div class="edu_testemonial_wrap">
                                        <figure><img class="quotes-photo" src="{{ $quote->nama_foto }}" alt="" />
                                        </figure>
                                        <div class="kode-text">
                                            <p>{{ $quote->teks }}</p>
                                            <a>{{ $quote->sumber }}</a>
                                        ...
                                        <div class="edu2_event_des">
                                            ...
                                            <ul>
                                                <li> <i class="fa fa-calendar"></i>
                                                    {{ date(' Y', strtotime($pengabdianKeMasyarakat->release_date)) }}
                                                </li>
                                            </ul>
                                            <p>
                                ...
                                <div class="col-md-6">
                                    <div class="edu2_event_wrap side_change">
                                        <div class="edu2_event_des">
                                            ...
                                            <ul>
                                                <li>{{ date(' Y', strtotime($pengabdianKeMasyarakat->release_date)) }} <i
                    ...
                    <div class="filterable-item all 2 1 9  col-sm-4 col-xs-12 no_padding">
                        <div class="edu2_gallery_des">
                            <figure>
                                ...
                                <figcaption>
                                    <a class="margin-eye margin-eye-respo" data-rel="prettyPhoto[gallery2]"
                                        href="{{ $galeri->nama_foto }}" data-lightbox="photos"><i
                                            class="fa fa-eye"></i></a>
                                </figcaption>
                            </figure>
                        </div>
                ...
                <div class="col-md-12">
                    <div class="row">
                        ...
                        <div class="kf_cur_catg_wrap">
                            ...
                            <!--COURSE CATEGORIES DES START-->
                            <div class="col-md-6">
                                <a href="{{ url('ruang_prodi_akademik') }}" class="kf_cur_catg_des color-3">
                                    <span><i class="icon-group2"></i></span>
                                    <div class="kf_cur_catg_capstion">
                                        <h5>Ruang Prodi Akademik</h5>
                                        <p>
                        ...
                        @foreach ($kemitraans as $kemitraan)
                            <div class="item">
                                ...
                                <div class="edu2_faculty_des">
                                    <img class="height-kemitraan" style=";object-fit:cover;"
                                        src="{{ url($kemitraan->nama_foto) }}" alt="" />
                                </div>
                                <!-- FACULTY DES END-->
                            </div>
                        @endforeach
