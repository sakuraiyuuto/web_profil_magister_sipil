...
@section('title', 'Dokumen Prodi - Magister Teknik Sipil UNTAN')
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-9">
                                                        ...
                                                        <div class="kf_event_list_des" style="padding: 10px 10px 10px 0;">
                                                            ...
                                                            <ul class="kf_event_list_links">
                                                                <li><a>Peneliti : {{ $dokumenProdi->author }}</a></li>
                                                                <br>
                                                                <li><a>Tahun Penelitian :
                                                                        {{ $dokumenProdi->release_date }}</a>
                                                                </li>
                                                            </ul>
                                                            <a class="readmore"
                                                                href="{{ url($dokumenProdi->slug) }}">
                                                                Selengkapnya
