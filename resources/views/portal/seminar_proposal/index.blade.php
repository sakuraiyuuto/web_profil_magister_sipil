...
@section('title', 'Seminar Proposal - Magister Teknik Sipil UNTAN')
                    ...
                    <div class="col-md-8">
                        <div class="abt_univ_wrap">
                            ...
                            <div class="kf_edu2_heading1">
                                <h3>Seminar Proposal Magister Teknik Sipil</h3>
                            </div>
                            <!-- HEADING 1 END-->
                            ...
                            <div class="download_btn">
                                <b>Dokumen : </b>
                                <a target="_blank" href="{{ url($seminarProposal->nama_file) }}" download
