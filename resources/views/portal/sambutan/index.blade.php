...
@section('title', 'Sambutan Ketua - Magister Teknik Sipil UNTAN')
                    ...
                    <div class="col-md-8">
                        <div class="abt_univ_wrap">
                            ...
                            <div class="kf_edu2_heading1">
                                <h3>Sambutan Ketua Magister Teknik Sipil</h3>
                            </div>
                            <!-- HEADING 1 END-->

                            <div class="abt_univ_des">
                                <div class="ck-content">
                                    {!! $sambutanPimpinanInstansi->teks !!}
                                </div>
                            </div>
                        </div>
                    </div>
