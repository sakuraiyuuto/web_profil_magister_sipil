...
@section('title', 'Akreditasi - Magister Teknik Sipil UNTAN')
                        ...
                        <div class="kf_blog_detail_wrap">
                            ...
                            <div class="kf_blog_detail_des">
                                <div class="blog-detl_heading">
                                    <h5>{{ $akreditasi->judul }}</h5>
                                </div>

                                <p>Dokumen :</p>
                                <div class="embed-responsive embed-responsive-4by3">
                                    <object data="{{ url($akreditasi->nama_file) }}" type="application/pdf">
                                        <iframe
