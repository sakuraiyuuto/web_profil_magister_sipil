...
@section('title', 'Prosiding - Magister Teknik Sipil UNTAN')
                                ...
                                <tbody>
                                    @foreach ($prosidings as $prosiding)
                                        <tr>
                                            ...
                                            <td><a href="{{ $prosiding->url }}">{{ $prosiding->judul }}</a></td>
                                            <td>{{ $prosiding->author }}</td>
                                            <td>{{ $prosiding->tahun }}</td>
                                            <td>{{ $prosiding->nomor_volume }}</td>
                                            <td><a class="btn btn-primary" href="{{ url($prosiding->nama_file) }}"
                                                    download target="_blank">Download</a></td>
                                        </tr>
                                    @endforeach
                                </tbody>
                            </table>
