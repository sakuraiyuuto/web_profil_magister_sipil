                ...
                <div class="col-md-12">
                    ...
                    <div class="kf_inr_ban_des">
                        <div class="inr_banner_heading">
                            <h3>Detail Layanan Mahasiswa</h3>
                        </div>

                        <div class="kf_inr_breadcrumb">
                            <ul>
                                <li><a href="{{ url('') }}">Beranda</a></li>
                                <li><a href="{{ url('/layanan_mahasiswa') }}">Layanan Mahasiswa</a></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="kf_blog_detail_wrap">
                            ...
                            <div class="blog_detail_thumbnail">
                                <figure>
                                    <img src="{{ url($layananMahasiswa->thumbnail) }}" alt="" />
                                    <figcaption><a href="#">Layanan Mahasiswa</a></figcaption>
                                </figure>
                            </div>
                            ...
                            <div class="kf_blog_detail_des">
                                <div class="blog-detl_heading">
                                    <h5>{{ $layananMahasiswa->judul }}</h5>
                                </div>
                                <ul class="blog_detail_meta">
                                    <li><i class="fa fa-calendar"></i><a
                                            href="#">{{ date('d M, Y', strtotime($layananMahasiswa->release_date)) }}</a>
                                    </li>
                                </ul>
                                <div class="ck-style-image">
                                <div class="ck-content">
                                    {!! $layananMahasiswa->teks !!}
                                </div>
                                </div>
                            </div>
