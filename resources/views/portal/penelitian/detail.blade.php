                    ...
                    <div class="col-md-8">
                        ...
                        <div class="kf_blog_detail_wrap">
                            ...
                            <div class="blog_detail_thumbnail">
                                <figure>
                                    <img src="{{ url($penelitian->thumbnail) }}" alt="" />
                                    <figcaption><a href="#">Penelitian</a></figcaption>
                                </figure>
                            </div>
                            ...
                            <div class="kf_blog_detail_des">
                                <div class="blog-detl_heading">
                                    <h5>{{ $penelitian->judul }}</h5>
                                </div>

                                <ul class="blog_detail_meta">
                                    <li><i class="fa fa-calendar"></i><a
                                            href="#">{{ date('d M, Y', strtotime($penelitian->release_date)) }}</a>
                                    </li>
                                </ul>
                                <ul class="blog_detail_meta">
                                    <li><a href="#">Peneliti : {{ $penelitian->author }}</a>
                                    </li>
                                </ul>
                                <ul class="blog_detail_meta">
