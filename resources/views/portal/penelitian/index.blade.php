...
@section('title', 'Penelitian - Magister Teknik Sipil UNTAN')
                                                ...
                                                <div class="row" style="height : 10rem">
                                                        ...
                                                        <div class="kf_event_list_thumb">
                                                            <figure style="height : 13rem">
                                                                <img style="height : 15rem; width:100%; object-fit :cover"
                                                                    src="{{ url($penelitian->thumbnail) }}" alt="" />
                                                            </figure>
                                                        </div>
                                                    ...
                                                    <div class="col-lg-9 col-md-9 col-sm-9">
                                                        ...
                                                        <div class="kf_event_list_des" style="padding: 10px 10px 10px 0;">
                                                            <h4><a
                                                                    href="{{ url($penelitian->slug) }}"><span>{{ $penelitian->judul }}</span></a>
                                                            </h4>
                                                            <ul class="kf_event_list_links">
                                                                <li><a>Peneliti : {{ $penelitian->author }}</a></li><br>
                                                                <li><a>Tahun Penelitian : {{ $penelitian->tahun }}</a>
                                                                </li>
                                                            </ul>
                                                            <a class="readmore" href="{{ url($penelitian->slug) }}">
                                                                Selengkapnya
