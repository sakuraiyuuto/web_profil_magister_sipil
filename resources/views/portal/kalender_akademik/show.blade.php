...
@section('title', 'Kalender Akademik - Magister Teknik Sipil UNTAN')
                    ...
                    <div class="kf_inr_ban_des">
                        ...
                        <div class="kf_inr_breadcrumb">
                            <ul>
                                ...
                                <li><a href="{{ url('/kalender_akademik') }}">Kalender Akademik</a></li>
                            </ul>
                        </div>
                    </div>
                        ...
                        <div class="kf_blog_detail_wrap">
                            ...
                            <div class="kf_blog_detail_des">
                                <div class="blog-detl_heading">
                                    <h5>{{ $kalenderAkademik->judul }}</h5>
                                </div>

                                <p>Dokumen : </p>

                                <div class="embed-responsive embed-responsive-4by3">
                                    <object data="{{ url($kalenderAkademik->nama_file) }}" type="application/pdf">
                                        <iframe
