...
@section('container')
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12 text-left">
                                        <a href="{{ url('/admin/berita/create') }}" type="button"
                                ...
                                <table id="tabel_berita" class="table table-bordered table-striped mt-2">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Judul</th>
                                        ...
                                        @foreach ($beritas as $berita)
                                            <tr id="{{ $berita->id }}">
                                                ...
                                                @if ($berita->deleted_at == '')
                                                    @if ($berita->release_date <= date('Y-m-d'))
                                                        <td>Rilis</td>
                                                    @else
                                                        <td>Belum Rilis</td>
                                                    @endif
                                                ...
                                                @else
                                                    <td>
                                                        <form
                                                            action="{{ url('/admin/berita/' . $berita->id . '/restore') }}"
                                                            method="post">
                                                            @csrf
                                                        ...
                                                        <form
                                                            action="{{ url('/admin/berita/' . $berita->id . '/delete') }}"
                                                            method="post">
                                                            @csrf
                                                            <button type="submit" class="btn btn-danger"
    ...
    <script>
        $(function() {
            ...
            }).buttons().container().appendTo('#tabel_berita_wrapper .col-md-6:eq(0)');
        });
    </script>
@endsection
