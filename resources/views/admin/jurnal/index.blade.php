                                                ...
                                                <tr>
                                                    ...
                                                    @if ($jurnal->nama_file != '')
                                                        <td><a class="btn btn-primary"
                                                                href="{{ url($jurnal->nama_file) }}" download
                ...
                <form id="formAdd" action="{{ url('/admin/jurnal') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mt-2">
                            ...
                            <input type="text" class="form-control mt-0" name="keterangan" maxlength="100" required
                                placeholder=". . .">
                        </div>
                        <div class="form-group mt-2">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control mt-0" name="nama_file" id="input_file_add"
                                accept="application/pdf">
                        </div>
                        <div class="form-group mt-2">
                            <label for="release_date">Jadwal Rilis</label>
                            <input type="date" class="form-control mt-0" name="release_date" max required>
                        </div>
                ...
                <div class="modal-content">
                    ...
                    <form id="formEdit" action="{{ route('jurnal.update', $jurnal->id) }}" method="POST"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group mt-2">
                                <label for="keterangan">Keterangan</label>
                                <input type="text" class="form-control mt-0" name="keterangan" id="keterangan"
