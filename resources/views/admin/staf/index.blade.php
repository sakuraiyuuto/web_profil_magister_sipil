                ...
                <form id="formAdd" action="{{ url('/admin/staf') }}" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mt-2">
                            ...
                            <input type="text" class="form-control mt-0" name="jabatan" required maxlength="100"
                                placeholder=". . .">
                        </div>
                ...
                <div class="modal-content">
                    ...
                    <form id="formEdit" action="{{ route('staf.update', $staf->id) }}" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group mt-2">
                                <label for="jabatan">Jabatan</label>
                                <input type="text" class="form-control mt-0" name="jabatan" id="jabatan" required
