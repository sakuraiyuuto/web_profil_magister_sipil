...
@section('container')
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-12 text-left">
                                        <a href="{{ url('/admin/penelitian/create') }}" type="button"
                                ...
                                <table id="tabel_penelitian" class="table table-bordered table-striped mt-2">
                                    <thead>
                                        <tr>
                                            <th>No</th>
                                            <th>Judul</th>
                                        ...
                                        @foreach ($penelitians as $penelitian)
                                            <tr id="{{ $penelitian->id }}">
                                                ...
                                                @if ($penelitian->deleted_at == '')
                                                    @if ($penelitian->release_date <= date('Y-m-d'))
                                                        <td>Rilis</td>
                                                    @else
                                                        <td>Belum Rilis</td>
                                                    @endif
                                                ...
                                                @if ($penelitian->deleted_at == '')
                                                    <td>
                                                        <a href="{{ route('penelitian.edit', $penelitian) }}"
                                                            class="btn btn-warning open-formModalEdit"><i
                                                                class="fa fa-edit"></i> Edit</a>
                                                        <form action="{{ route('penelitian.destroy', $penelitian) }}"
                                                            method="post">
                                                            @method('delete')
                                                            @csrf
                                                ...
                                                @else
                                                    <td>
                                                        <form
                                                            action="{{ url('/admin/penelitian/' . $penelitian->id . '/restore') }}"
                                                            method="post">
                                                            @csrf
                                                        ...
                                                        <form
                                                            action="{{ url('/admin/penelitian/' . $penelitian->id . '/delete') }}"
                                                            method="post">
                                                            @csrf
                                                            <button type="submit" class="btn btn-danger"
    ...
    <script>
        $(function() {
            ...
            }).buttons().container().appendTo('#tabel_penelitian_wrapper .col-md-6:eq(0)');
        });
    </script>
@endsection
