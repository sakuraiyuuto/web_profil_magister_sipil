                ...
                <form id="formAdd" action="{{ url('/admin/profil_lulusan') }}" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group mt-2">
                            ...
                            <input type="number" class="form-control mt-0" min="0" max="4" step="0.1" name="ipk" required>
                        </div>
                        <div class="form-group mt-2">
                        ...
                        <div class="form-group mt-2">
                            ...
                            <input type="text" class="form-control mt-0" name="nomor_ijazah" required maxlength="100"
                                placeholder=". . .">
                        </div>
                ...
                <div class="modal-content">
                    ...
                    <form id="formEdit" action="{{ route('profil_lulusan.update', $profilLulusan->id) }}" method="POST">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group mt-2">
                                <label for="ipk">IPK</label>
                                <input type="number" class="form-control mt-0" min="0" max="4" step="0.1" name="ipk"
                                    id="ipk" required>
                            </div>
                            <div class="form-group mt-2">
                                <label for="angkatan">Angkatan</label>
                            ...
                            <div class="form-group mt-2">
                                <label for="nomor_ijazah">Nomor Ijazah</label>
                                <input type="text" class="form-control mt-0" name="nomor_ijazah" id="nomor_ijazah" required
...
@section('script')
    ...
    <script>
        ...
        $(document).on("click", ".open-formModalEdit", function() {
            ...
            var nomor_ijazah = $(this).data('nomor_ijazah');

            $(".modal-body #id").val(id);
            $(".modal-body #nama").val(nama);
            $(".modal-body #nim").val(nim);
            $(".modal-body #ipk").val(ipk);
            $(".modal-body #angkatan").val(angkatan);
            $(".modal-body #tahun_lulus").val(tahun_lulus);
            $(".modal-body #nomor_ijazah").val(nomor_ijazah);
        });
    </script>
