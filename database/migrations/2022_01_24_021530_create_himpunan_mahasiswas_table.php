...
class CreateHimpunanMahasiswasTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('himpunan_mahasiswas')->insert(
            array(
                [
                    'nama' => 'Himpunan Mahasiswa Sarjana Teknik Sipil',
                    ...
                    'facebook' => "Himpunan Mahasiswa Sarjana Sipil",
                    'url_facebook' => "https://www.facebook.com/",
                    'instagram' => "Himpunan Mahasiswa Sarjana Sipil",
                    'url_instagram' => "https://www.instagram.com/",
                    'youtube' => "Himpunan Mahasiswa Sarjana Sipil",
                    'url_youtube' => "https://www.youtube.com/",
                    'twitter' => "Himpunan Mahasiswa Sarjana Sipil",
