...
class CreateHimpunanMahasiswasTable extends Migration
{
    ...
    public function up()
    {
        ...
        DB::table('himpunan_mahasiswas')->insert(
            array(
                [
                    'nama' => 'Himpunan Mahasiswa Magister Teknik Sipil',
                    ...
                    'facebook' => "Himpunan Mahasiswa Magister Sipil",
                    'url_facebook' => "https://www.facebook.com/",
                    'instagram' => "Himpunan Mahasiswa Magister Sipil",
                    'url_instagram' => "https://www.instagram.com/",
                    'youtube' => "Himpunan Mahasiswa Magister Sipil",
                    'url_youtube' => "https://www.youtube.com/",
                    'twitter' => "Himpunan Mahasiswa Magister Sipil",
